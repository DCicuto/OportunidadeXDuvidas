...
namespace APIDuvidasXOportunidades.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class OportunidadesController : ControllerBase
    {
        private readonly APIDuvidasXOportunidadesContext _context;

        public OportunidadesController(APIDuvidasXOportunidadesContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Oportunidade>> PostOportunidade(Oportunidade oportunidade)
        {
          if (_context.Oportunidade == null)
          {
              return Problem("Entity set 'APIDuvidasXOportunidadesContext.Oportunidade'  is null.");
          }
